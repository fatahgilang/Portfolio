  ...
  return (
    <section id="skills" className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16">
          <h3 className="text-4xl font-extrabold text-center mb-10 bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Keahlian Utama</h3>
